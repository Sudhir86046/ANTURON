...
export default function DashboardAccessPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#050816] px-4 py-10 text-white sm:px-6">
      ...
      <div className="absolute -top-24 -left-16 h-72 w-72 animate-pulse rounded-full bg-orange-500/50 blur-3xl" />
      <div className="absolute top-1/3 -right-20 h-80 w-80 animate-pulse rounded-full bg-orange-400/40 blur-3xl" />
      <div className="absolute bottom-0 left-1/3 h-72 w-72 animate-pulse rounded-full bg-amber-500/30 blur-3xl" />

      <div className="absolute left-[10%] top-[18%] h-24 w-24 animate-[bounce_6s_ease-in-out_infinite] rounded-full border border-orange-400/30 bg-orange-500/10 blur-sm" />
      <div className="absolute right-[12%] top-[22%] h-16 w-16 animate-[bounce_8s_ease-in-out_infinite] rounded-full border border-orange-300/40 bg-orange-300/10 blur-sm" />
      <div className="absolute bottom-[18%] left-[18%] h-20 w-20 animate-[bounce_7s_ease-in-out_infinite] rounded-full border border-orange-500/30 bg-orange-400/10 blur-sm" />
